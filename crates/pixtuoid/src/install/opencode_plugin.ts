// @pixtuoid-opencode-plugin — managed by Maple Agent Market (`maple-agent-market connect|disconnect opencode`).
//
...
// delete — `maple-agent-market disconnect opencode` replaces this
