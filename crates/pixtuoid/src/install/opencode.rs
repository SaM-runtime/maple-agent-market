...
const REMOVED_STUB: &str = "// Maple Agent Market opencode plugin removed by `maple-agent-market disconnect opencode`.\nexport {}\n";
...
/// so `setup` offers it? Probe opencode's OWN dirs — the config
