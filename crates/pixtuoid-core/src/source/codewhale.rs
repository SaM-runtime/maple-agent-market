...
//! hooks.toml`); `maple-agent-market connect codewhale` registers
...
//! `crates/tui/src/hooks.rs::HookContext::to_env_vars` @0.8.59 — since split to
//! `crates/tui/src/hooks/executor.rs`, same body — and a live
